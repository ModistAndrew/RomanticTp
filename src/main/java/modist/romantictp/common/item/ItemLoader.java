...
public class ItemLoader {
    ...
    public static final LazyOptional<List<ItemStack>> SCORE_LIST = LazyOptional.of(ItemLoader::createScoreList);
    ...
    private static List<ItemStack> createScoreList() {
        List<ItemStack> list = new ArrayList<>();
        list.addAll(SCORE.get().getDisplay());
        return list;
    }
    ...
    public static final RegistryObject<CreativeModeTab> ROMANTICTP_TAB = TABS.register("romantictp_tab",() -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                SCORE_LIST.ifPresent(l -> l.forEach(output::accept));
