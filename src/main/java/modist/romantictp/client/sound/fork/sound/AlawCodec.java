...
public final class AlawCodec extends FormatConversionProvider {
    ...
    public Encoding[] getTargetEncodings(AudioFormat sourceFormat){
        ...
        } else if( sourceFormat.getEncoding().equals( Encoding.ALAW ) ) {
    ...
    public AudioFormat[] getTargetFormats(Encoding targetEncoding, AudioFormat sourceFormat){
        ...
        if( (targetEncoding.equals( Encoding.PCM_SIGNED ) && sourceFormat.getEncoding().equals( Encoding.ALAW)) ||
            (targetEncoding.equals( Encoding.ALAW) && sourceFormat.getEncoding().equals( Encoding.PCM_SIGNED)) ) {
    ...
    public AudioInputStream getAudioInputStream(Encoding targetEncoding, AudioInputStream sourceStream){
        ...
        if( sourceEncoding.equals( Encoding.ALAW ) &&
            targetEncoding.equals( Encoding.PCM_SIGNED ) ) {
        ...
        } else if( sourceEncoding.equals( Encoding.PCM_SIGNED ) &&
                   targetEncoding.equals( Encoding.ALAW ) ) {
    ...
    private AudioFormat[] getOutputFormats(AudioFormat inputFormat) {
        ...
        if (inputFormat.getSampleSizeInBits() == 16
            ...
            format = new AudioFormat(Encoding.ALAW,
        ...
        if (inputFormat.getSampleSizeInBits() == 8
                && Encoding.ALAW.equals(inputFormat.getEncoding())) {
    ...
    private final class AlawCodecStream extends AudioInputStream {
        ...
        AlawCodecStream(AudioInputStream stream, AudioFormat outputFormat) {
            ...
            if (Encoding.ALAW.equals(inputFormat.getEncoding())) {
                encode = false;
