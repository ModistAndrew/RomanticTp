...
final class RealTimeSequencer extends AbstractMidiDevice
     ...
     */
    static final Info info = new RealTimeSequencerInfo();


    private static final SyncMode[] masterSyncModes = { SyncMode.INTERNAL_CLOCK };
    private static final SyncMode[] slaveSyncModes  = { SyncMode.NO_SYNC };

    private static final SyncMode masterSyncMode    = SyncMode.INTERNAL_CLOCK;
    private static final SyncMode slaveSyncMode     = SyncMode.NO_SYNC;
    ...
    public SyncMode[] getMasterSyncModes() {
        SyncMode[] returnedModes = new SyncMode[masterSyncModes.length];
    ...
    public SyncMode[] getSlaveSyncModes() {
        SyncMode[] returnedModes = new SyncMode[slaveSyncModes.length];
    ...
    private static class RealTimeSequencerInfo extends Info {
